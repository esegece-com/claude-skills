...
Add `IdLPR` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `JobId: String` | `String` | `__property UnicodeString JobId;` |
| `Queue: String` | `String` | `__property UnicodeString Queue;` |
| `ControlFile: TIdLPRControlFile` | [TIdLPRControlFile](../types/TIdLPRControlFile.md) | `__property TIdLPRControlFile * ControlFile;` |
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnLPRStatus: TIdLPRStatusEvent` | [TIdLPRStatusEvent](../types/TIdLPRStatusEvent.md) | `__property TIdLPRStatusEvent OnLPRStatus;` |
...
void __fastcall Print(const UnicodeString AText);
void __fastcall PrintFile(const UnicodeString AFileName);
UnicodeString __fastcall GetQueueState(const bool AShortFormat = False, const UnicodeString AList = '');
void __fastcall PrintWaitingJobs();
void __fastcall RemoveJobList(const UnicodeString AList, const bool AAsRoot = False);
