...
Add `IdLogEvent` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnReceived: TLogItemDataEvent` | [TLogItemDataEvent](../types/TLogItemDataEvent.md) | `__property TLogItemDataEvent OnReceived;` |
| `OnSent: TLogItemDataEvent` | [TLogItemDataEvent](../types/TLogItemDataEvent.md) | `__property TLogItemDataEvent OnSent;` |
| `OnStatus: TLogItemStatusEvent` | [TLogItemStatusEvent](../types/TLogItemStatusEvent.md) | `__property TLogItemStatusEvent OnStatus;` |
