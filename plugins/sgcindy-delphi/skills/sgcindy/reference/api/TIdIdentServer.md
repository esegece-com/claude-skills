...
Add `IdIdentServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `QueryTimeOut: Integer` | `Integer` | `__property int QueryTimeOut;` |
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnIdentQuery: TIdIdentQueryEvent` | [TIdIdentQueryEvent](../types/TIdIdentQueryEvent.md) | `__property TIdIdentQueryEvent OnIdentQuery;` |
...
Procedure ReplyIdent(AContext:TIdContext; AServerPort, AClientPort : TIdPort; AOS, AUserName : String; const ACharset : String = '');
...
```cpp
void __fastcall ReplyError(TIdContext * AContext, TIdPort * AServerPort, TIdPort * AClientPort, TIdIdentErrorType * AErr);
void __fastcall ReplyIdent(TIdContext * AContext, TIdPort * AServerPort, TIdPort * AClientPort, UnicodeString AOS, UnicodeString AUserName, const UnicodeString ACharset = '');
void __fastcall ReplyOther(TIdContext * AContext, TIdPort * AServerPort, TIdPort * AClientPort, UnicodeString AOther);
