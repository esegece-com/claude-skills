...
Add `IdInterceptThrottler` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `BitsPerSec: Integer` | `Integer` | `__property int BitsPerSec;` |
| `RecvBitsPerSec: Integer` | `Integer` | `__property int RecvBitsPerSec;` |
| `SendBitsPerSec: Integer` | `Integer` | `__property int SendBitsPerSec;` |
