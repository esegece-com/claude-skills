...
Add `IdTelnet` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `TelnetThread: TIdTelnetReadThread (read-only)` | [TIdTelnetReadThread](../types/TIdTelnetReadThread.md) | `__property TIdTelnetReadThread * TelnetThread /* read-only */;` |
| `Host: String` | `String` | `__property UnicodeString Host;` |
| `Port: TIdPort` | `TIdPort` | `__property TIdPort * Port;` |
| `Terminal: string` | `string` | `__property UnicodeString Terminal;` |
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnTelnetCommand: TIdTelnetCommandEvent` | [TIdTelnetCommandEvent](../types/TIdTelnetCommandEvent.md) | `__property TIdTelnetCommandEvent OnTelnetCommand;` |
| `OnDataAvailable: TIdTelnetDataAvailEvent` | [TIdTelnetDataAvailEvent](../types/TIdTelnetDataAvailEvent.md) | `__property TIdTelnetDataAvailEvent OnDataAvailable;` |
...
void __fastcall SendCh(wchar_t Ch);
void __fastcall SendString(const UnicodeString S);
