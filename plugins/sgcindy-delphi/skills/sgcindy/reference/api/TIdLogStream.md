...
Add `IdLogStream` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| `ReceiveStream: TStream` | `TStream` | `__property TStream * ReceiveStream;` |
| `SendStream: TStream` | `TStream` | `__property TStream * SendStream;` |
