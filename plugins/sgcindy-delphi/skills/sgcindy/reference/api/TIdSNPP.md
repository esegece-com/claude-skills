...
Add `IdSNPP` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
void __fastcall SendMessage(UnicodeString APagerId, UnicodeString AMsg);
