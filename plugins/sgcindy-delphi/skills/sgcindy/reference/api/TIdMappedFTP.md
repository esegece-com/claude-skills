...
Add `IdMappedFTP` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| `OutboundDcMode: TIdMappedFtpOutboundDcMode` | [TIdMappedFtpOutboundDcMode](../types/TIdMappedFtpOutboundDcMode.md) | `__property TIdMappedFtpOutboundDcMode * OutboundDcMode;` |
