...
Add `IdQOTDUDP` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `Quote: String (read-only)` | `String` | `__property UnicodeString Quote /* read-only */;` |
