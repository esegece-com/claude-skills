...
Add `IdSystatUDP` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
```cpp
void __fastcall GetStat(TStrings * ADest);
