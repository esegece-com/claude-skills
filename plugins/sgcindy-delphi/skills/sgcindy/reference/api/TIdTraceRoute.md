...
Add `IdTraceRoute` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| `ResolveHostNames: Boolean` | `Boolean` | `__property bool ResolveHostNames;` |
