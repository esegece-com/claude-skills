...
Add `IdQOTDUDPServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnCommandQOTD: TIdQotdUDPGetEvent` | [TIdQotdUDPGetEvent](../types/TIdQotdUDPGetEvent.md) | `__property TIdQotdUDPGetEvent OnCommandQOTD;` |
