...
Add `IdRexecServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnCommand: TIdRexecCommandEvent` | [TIdRexecCommandEvent](../types/TIdRexecCommandEvent.md) | `__property TIdRexecCommandEvent OnCommand;` |
