...
Add `IdRSH` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `ClientUserName: String` | `String` | `__property UnicodeString ClientUserName;` |
| `Host: String` | `String` | `__property UnicodeString Host;` |
| `HostUserName: String` | `String` | `__property UnicodeString HostUserName;` |
| `Port: TIdPort` | `TIdPort` | `__property TIdPort * Port;` |
| `UseReservedPorts: Boolean` | `Boolean` | `__property bool UseReservedPorts;` |
| `ErrorReply: Boolean (read-only)` | `Boolean` | `__property bool ErrorReply /* read-only */;` |
| `ErrorMessage: String (read-only)` | `String` | `__property UnicodeString ErrorMessage /* read-only */;` |
| `UseStdError: Boolean` | `Boolean` | `__property bool UseStdError;` |
...
```pascal
Function Execute(ACommand: String): String;
procedure Connect;
...
```cpp
UnicodeString __fastcall Execute(UnicodeString ACommand);
