...
Add `IdHTTPProxyServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| `DefaultTransferMode: TIdHTTPProxyTransferMode` | [TIdHTTPProxyTransferMode](../types/TIdHTTPProxyTransferMode.md) | `__property TIdHTTPProxyTransferMode * DefaultTransferMode;` |
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnHTTPBeforeCommand: TOnHTTPContextEvent` | [TOnHTTPContextEvent](../types/TOnHTTPContextEvent.md) | `__property TOnHTTPContextEvent OnHTTPBeforeCommand;` |
| `OnHTTPResponse: TOnHTTPContextEvent` | [TOnHTTPContextEvent](../types/TOnHTTPContextEvent.md) | `__property TOnHTTPContextEvent OnHTTPResponse;` |
| `OnHTTPDocument: TOnHTTPDocument` | [TOnHTTPDocument](../types/TOnHTTPDocument.md) | `__property TOnHTTPDocument OnHTTPDocument;` |
