...
Add `IdTelnetServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| `LoginAttempts: Integer` | `Integer` | `__property int LoginAttempts;` |
| `LoginMessage: String` | `String` | `__property UnicodeString LoginMessage;` |
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnAuthentication: TAuthenticationEvent` | [TAuthenticationEvent](../types/TAuthenticationEvent.md) | `__property TAuthenticationEvent OnAuthentication;` |
| `OnNegotiate: TIdTelnetNegotiateEvent` | [TIdTelnetNegotiateEvent](../types/TIdTelnetNegotiateEvent.md) | `__property TIdTelnetNegotiateEvent OnNegotiate;` |
...
```pascal
function DoAuthenticate(AContext: TIdContext; const AUsername, APassword: string) : boolean;
procedure DoNegotiate(AContext: TIdContext);
...
```cpp
bool __fastcall DoAuthenticate(TIdContext * AContext, const UnicodeString AUsername, const UnicodeString APassword);
void __fastcall DoNegotiate(TIdContext * AContext);
