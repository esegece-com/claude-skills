...
Add `IdWhoIsServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnCommandLookup: TGetEvent` | [TGetEvent](../types/TGetEvent.md) | `__property TGetEvent OnCommandLookup;` |
