...
Add `IdTimeUDP` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `BaseDate: TDateTime` | `TDateTime` | `__property System::TDateTime BaseDate;` |
| `Port: TIdPort` | `TIdPort` | `__property TIdPort * Port;` |
| `DateTimeCard: UInt32 (read-only)` | `UInt32` | `__property UInt32 DateTimeCard /* read-only */;` |
| `DateTime: TDateTime (read-only)` | `TDateTime` | `__property System::TDateTime DateTime /* read-only */;` |
| `RoundTripDelay: UInt32 (read-only)` | `UInt32` | `__property UInt32 RoundTripDelay /* read-only */;` |
