...
Add `IdSocksServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| `AllowSocks4: Boolean` | `Boolean` | `__property bool AllowSocks4;` |
| `AllowSocks5: Boolean` | `Boolean` | `__property bool AllowSocks5;` |
| `NeedsAuthentication: Boolean` | `Boolean` | `__property bool NeedsAuthentication;` |
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnAuthenticate: TIdOnAuthenticate` | [TIdOnAuthenticate](../types/TIdOnAuthenticate.md) | `__property TIdOnAuthenticate * OnAuthenticate;` |
| `OnBeforeSocksConnect: TIdOnBeforeEvent` | [TIdOnBeforeEvent](../types/TIdOnBeforeEvent.md) | `__property TIdOnBeforeEvent OnBeforeSocksConnect;` |
| `OnBeforeSocksBind: TIdOnBeforeEvent` | [TIdOnBeforeEvent](../types/TIdOnBeforeEvent.md) | `__property TIdOnBeforeEvent OnBeforeSocksBind;` |
| `OnVerifyBoundPeer: TIdOnVerifyEvent` | [TIdOnVerifyEvent](../types/TIdOnVerifyEvent.md) | `__property TIdOnVerifyEvent OnVerifyBoundPeer;` |
