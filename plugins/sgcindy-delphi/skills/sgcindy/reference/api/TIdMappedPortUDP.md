...
Add `IdMappedPortUDP` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnRequest: TNotifyEvent` | `TNotifyEvent` | `__property TNotifyEvent OnRequest;` |
