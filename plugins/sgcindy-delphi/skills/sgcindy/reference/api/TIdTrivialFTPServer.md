...
Add `IdTrivialFTPServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnReadFile: TAccessFileEvent` | [TAccessFileEvent](../types/TAccessFileEvent.md) | `__property TAccessFileEvent OnReadFile;` |
| `OnWriteFile: TAccessFileEvent` | [TAccessFileEvent](../types/TAccessFileEvent.md) | `__property TAccessFileEvent OnWriteFile;` |
| `OnTransferComplete: TTransferCompleteEvent` | [TTransferCompleteEvent](../types/TTransferCompleteEvent.md) | `__property TTransferCompleteEvent OnTransferComplete;` |
