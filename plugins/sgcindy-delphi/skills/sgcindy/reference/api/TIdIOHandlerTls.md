...
Add `IdIOHandlerTls` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `Options: TIdTlsClientOptions` | [TIdTlsClientOptions](../types/TIdTlsClientOptions.md) | `__property TIdTlsClientOptions * Options;` |
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnValidateCertificate: CertificateValidationCallback` | `CertificateValidationCallback` | `__property CertificateValidationCallback OnValidateCertificate;` |
