...
Add `IdSysLogServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnSyslog: TOnSyslogEvent` | [TOnSyslogEvent](../types/TOnSyslogEvent.md) | `__property TOnSyslogEvent OnSyslog;` |
