...
Add `IdSystatUDPServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnSystat: TIdUDPSystatEvent` | [TIdUDPSystatEvent](../types/TIdUDPSystatEvent.md) | `__property TIdUDPSystatEvent OnSystat;` |
