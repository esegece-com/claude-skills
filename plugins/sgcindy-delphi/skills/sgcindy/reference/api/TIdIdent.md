...
Add `IdIdent` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `Reply: String (read-only)` | `String` | `__property UnicodeString Reply /* read-only */;` |
| `ReplyCharset: String (read-only)` | `String` | `__property UnicodeString ReplyCharset /* read-only */;` |
| `ReplyOS: String (read-only)` | `String` | `__property UnicodeString ReplyOS /* read-only */;` |
| `ReplyOther: String (read-only)` | `String` | `__property UnicodeString ReplyOther /* read-only */;` |
| `ReplyUserName: String (read-only)` | `String` | `__property UnicodeString ReplyUserName /* read-only */;` |
...
```cpp
void __fastcall Query(unsigned short APortOnServer, unsigned short APortOnClient);
