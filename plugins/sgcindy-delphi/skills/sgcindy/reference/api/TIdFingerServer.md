...
Add `IdFingerServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnCommandFinger: TIdFingerGetEvent` | [TIdFingerGetEvent](../types/TIdFingerGetEvent.md) | `__property TIdFingerGetEvent OnCommandFinger;` |
| `OnCommandVerboseFinger: TIdFingerGetEvent` | [TIdFingerGetEvent](../types/TIdFingerGetEvent.md) | `__property TIdFingerGetEvent OnCommandVerboseFinger;` |
