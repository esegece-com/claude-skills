...
Add `IdDayTimeUDPServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `TimeZone: String` | `String` | `__property UnicodeString TimeZone;` |
