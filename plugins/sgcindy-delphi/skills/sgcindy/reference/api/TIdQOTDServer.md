...
Add `IdQotdServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnCommandQOTD: TIdQOTDGetEvent` | [TIdQOTDGetEvent](../types/TIdQOTDGetEvent.md) | `__property TIdQOTDGetEvent OnCommandQOTD;` |
