...
Add `IdIOHandlerStream` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `ReceiveStream: TStream (read-only)` | `TStream` | `__property TStream * ReceiveStream /* read-only */;` |
| `SendStream: TStream (read-only)` | `TStream` | `__property TStream * SendStream /* read-only */;` |
| `StreamType: TIdIOHandlerStreamType (read-only)` | [TIdIOHandlerStreamType](../types/TIdIOHandlerStreamType.md) | `__property TIdIOHandlerStreamType * StreamType /* read-only */;` |
| `FreeStreams: Boolean` | `Boolean` | `__property bool FreeStreams;` |
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnGetStreams: TIdOnGetStreams` | [TIdOnGetStreams](../types/TIdOnGetStreams.md) | `__property TIdOnGetStreams * OnGetStreams;` |
