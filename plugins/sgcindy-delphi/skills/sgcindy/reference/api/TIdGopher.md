...
Add `IdGopher` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnMenuItem: TIdGopherMenuEvent` | [TIdGopherMenuEvent](../types/TIdGopherMenuEvent.md) | `__property TIdGopherMenuEvent OnMenuItem;` |
...
```cpp
TIdGopherMenu * __fastcall GetMenu(UnicodeString ASelector, bool IsGopherPlus = False, UnicodeString AView = '');
TIdGopherMenu * __fastcall Search(UnicodeString ASelector, UnicodeString AQuery);
void __fastcall GetFile(UnicodeString ASelector, TStream * ADestStream, bool IsGopherPlus = False, UnicodeString AView = '');
void __fastcall GetTextFile(UnicodeString ASelector, TStream * ADestStream, bool IsGopherPlus = False, UnicodeString AView = '');
TIdGopherMenu * __fastcall GetExtendedMenu(UnicodeString ASelector, UnicodeString AView = '');
