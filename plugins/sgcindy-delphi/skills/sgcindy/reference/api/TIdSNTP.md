...
Add `IdSNTP` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `AdjustmentTime: TDateTime (read-only)` | `TDateTime` | `__property System::TDateTime AdjustmentTime /* read-only */;` |
| `DateTime: TDateTime (read-only)` | `TDateTime` | `__property System::TDateTime DateTime /* read-only */;` |
| `RoundTripDelay: TDateTime (read-only)` | `TDateTime` | `__property System::TDateTime RoundTripDelay /* read-only */;` |
| `CheckStratum: Boolean` | `Boolean` | `__property bool CheckStratum;` |
