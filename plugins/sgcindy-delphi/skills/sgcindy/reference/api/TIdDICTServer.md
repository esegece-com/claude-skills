...
Add `IdDICTServer` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| Delphi | Type | C++Builder |
| --- | --- | --- |
| `OnCommandHelp: TIdDICTGetEvent` | [TIdDICTGetEvent](../types/TIdDICTGetEvent.md) | `__property TIdDICTGetEvent OnCommandHelp;` |
| `OnCommandDefine: TIdDICTDefineEvent` | [TIdDICTDefineEvent](../types/TIdDICTDefineEvent.md) | `__property TIdDICTDefineEvent OnCommandDefine;` |
| `OnCommandMatch: TIdDICTMatchEvent` | [TIdDICTMatchEvent](../types/TIdDICTMatchEvent.md) | `__property TIdDICTMatchEvent OnCommandMatch;` |
| `OnCommandQuit: TIdDICTGetEvent` | [TIdDICTGetEvent](../types/TIdDICTGetEvent.md) | `__property TIdDICTGetEvent OnCommandQuit;` |
| `OnCommandShow: TIdDICTShowEvent` | [TIdDICTShowEvent](../types/TIdDICTShowEvent.md) | `__property TIdDICTShowEvent OnCommandShow;` |
| `OnCommandAuth: TIdDICTAuthEvent` | [TIdDICTAuthEvent](../types/TIdDICTAuthEvent.md) | `__property TIdDICTAuthEvent OnCommandAuth;` |
| `OnCommandSASLAuth: TIdDICTAuthEvent` | [TIdDICTAuthEvent](../types/TIdDICTAuthEvent.md) | `__property TIdDICTAuthEvent OnCommandSASLAuth;` |
| `OnCommandOption: TIdDICTOtherEvent` | [TIdDICTOtherEvent](../types/TIdDICTOtherEvent.md) | `__property TIdDICTOtherEvent OnCommandOption;` |
| `OnCommandStatus: TIdDICTGetEvent` | [TIdDICTGetEvent](../types/TIdDICTGetEvent.md) | `__property TIdDICTGetEvent OnCommandStatus;` |
| `OnCommandClient: TIdDICTShowEvent` | [TIdDICTShowEvent](../types/TIdDICTShowEvent.md) | `__property TIdDICTShowEvent OnCommandClient;` |
| `OnCommandOther: TIdDICTOtherEvent` | [TIdDICTOtherEvent](../types/TIdDICTOtherEvent.md) | `__property TIdDICTOtherEvent OnCommandOther;` |
