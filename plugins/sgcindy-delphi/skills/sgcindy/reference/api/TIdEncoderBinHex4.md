...
Add `IdCoderBinHex4` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
```pascal
procedure Encode(ASrcStream: TStream; ADestStream: TStream; const ABytes: Integer = -1);
