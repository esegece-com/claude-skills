...
sgcIndy is an eSeGeCe component library for Delphi and C++Builder. This skill ships its public API surface only (properties, events, methods), so you can write correct code without the library source.
...
- `reference/history.md` lists what changed in each sgcIndy release.
