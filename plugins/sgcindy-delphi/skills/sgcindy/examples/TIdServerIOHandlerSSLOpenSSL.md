# TIdServerIOHandlerSSLOpenSSL - Example

Full source of `fTcpServer.pas` from the **TcpServer** demo, which uses `TIdServerIOHandlerSSLOpenSSL`.

API reference: [TIdServerIOHandlerSSLOpenSSL](../reference/api/TIdServerIOHandlerSSLOpenSSL.md)
