# TIdSSLIOHandlerSocketOpenSSL - Example

Full source of `fFtpClient.pas` from the **FtpClient** demo, which uses `TIdSSLIOHandlerSocketOpenSSL`.

API reference: [TIdSSLIOHandlerSocketOpenSSL](../reference/api/TIdSSLIOHandlerSocketOpenSSL.md)
