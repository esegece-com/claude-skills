# TIdUDPServer - Example

Full source of `fUDPClientServer.pas` from the **UDPClientServer** demo, which uses `TIdUDPServer`.

API reference: [TIdUDPServer](../reference/api/TIdUDPServer.md)
