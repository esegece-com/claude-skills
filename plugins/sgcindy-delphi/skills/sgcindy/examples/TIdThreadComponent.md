# TIdThreadComponent - Example

Full source of `fTcpClient.pas` from the **TcpClient** demo, which uses `TIdThreadComponent`.

API reference: [TIdThreadComponent](../reference/api/TIdThreadComponent.md)
Source demo: `TcpClient` (file `fTcpClient.pas`)
