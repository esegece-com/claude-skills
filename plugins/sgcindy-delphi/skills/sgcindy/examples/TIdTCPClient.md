# TIdTCPClient - Example

Full source of `fTcpClient.pas` from the **TcpClient** demo, which uses `TIdTCPClient`.

API reference: [TIdTCPClient](../reference/api/TIdTCPClient.md)
