...
Components grouped by the edition or feature define that gates them. "requires <DEFINE>" means the component is only available when that conditional define is active in your build.
...
## requires SGC_HTTP_OPENAPI_SERVER
