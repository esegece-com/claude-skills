...
| --- | --- | --- |
| `Items: TsgcHTMLTabItems` | [TsgcHTMLTabItems](../types/TsgcHTMLTabItems.md) | `__property TsgcHTMLTabItems * Items;` |
| `Style: TsgcHTMLTabStyle` | [TsgcHTMLTabStyle](../types/TsgcHTMLTabStyle.md) | `__property TsgcHTMLTabStyle * Style;` |
| `Vertical: Boolean` | `Boolean` | `__property bool Vertical;` |
| `Fill: Boolean` | `Boolean` | `__property bool Fill;` |
| `Justify: Boolean` | `Boolean` | `__property bool Justify;` |
| `TabsID: string` | `string` | `__property UnicodeString TabsID;` |
