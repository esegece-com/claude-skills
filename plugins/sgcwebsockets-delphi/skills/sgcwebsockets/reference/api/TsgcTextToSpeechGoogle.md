...
| `GoogleOptions: TsgcTextToSpeechGoogleOptions` | [TsgcTextToSpeechGoogleOptions](../types/TsgcTextToSpeechGoogleOptions.md) | `__property TsgcTextToSpeechGoogleOptions * GoogleOptions;` |
