...
| --- | --- | --- |
| `Items: TsgcHTMLSidebarItems` | [TsgcHTMLSidebarItems](../types/TsgcHTMLSidebarItems.md) | `__property TsgcHTMLSidebarItems * Items;` |
...
| `Fixed: Boolean` | `Boolean` | `__property bool Fixed;` |
| `SidebarID: string` | `string` | `__property UnicodeString SidebarID;` |
