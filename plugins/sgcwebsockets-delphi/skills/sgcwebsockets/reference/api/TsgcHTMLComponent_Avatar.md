...
Add `sgcHTML_Component_Avatar` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `ImageURL: string` | `string` | `__property UnicodeString ImageURL;` |
| `Initials: string` | `string` | `__property UnicodeString Initials;` |
| `AltText: string` | `string` | `__property UnicodeString AltText;` |
| `Size: TsgcHTMLAvatarSize` | [TsgcHTMLAvatarSize](../types/TsgcHTMLAvatarSize.md) | `__property TsgcHTMLAvatarSize * Size;` |
| `Status: TsgcHTMLAvatarStatus` | [TsgcHTMLAvatarStatus](../types/TsgcHTMLAvatarStatus.md) | `__property TsgcHTMLAvatarStatus * Status;` |
| `Shape: TsgcHTMLAvatarShape` | [TsgcHTMLAvatarShape](../types/TsgcHTMLAvatarShape.md) | `__property TsgcHTMLAvatarShape * Shape;` |
...
| `AvatarID: string` | `string` | `__property UnicodeString AvatarID;` |
| `StatusBorderWidth: Integer` | `Integer` | `__property int StatusBorderWidth;` |
| `StatusBorderColor: TsgcHTMLColor` | [TsgcHTMLColor](../types/TsgcHTMLColor.md) | `__property TsgcHTMLColor * StatusBorderColor;` |
