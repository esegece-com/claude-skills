...
| --- | --- | --- |
| `PrependText: string` | `string` | `__property UnicodeString PrependText;` |
| `AppendText: string` | `string` | `__property UnicodeString AppendText;` |
| `InputType: string` | `string` | `__property UnicodeString InputType;` |
| `InputName: string` | `string` | `__property UnicodeString InputName;` |
| `InputValue: string` | `string` | `__property UnicodeString InputValue;` |
| `Placeholder: string` | `string` | `__property UnicodeString Placeholder;` |
| `Size: TsgcHTMLInputGroupSize` | [TsgcHTMLInputGroupSize](../types/TsgcHTMLInputGroupSize.md) | `__property TsgcHTMLInputGroupSize * Size;` |
| `GroupID: string` | `string` | `__property UnicodeString GroupID;` |
| `InputTypeEnum: TsgcHTMLInputType` | [TsgcHTMLInputType](../types/TsgcHTMLInputType.md) | `__property TsgcHTMLInputType * InputTypeEnum;` |
