...
unit: sgcHTML_Component_FileUpload
Edition: All-Access

Add `sgcHTML_Component_FileUpload` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `UploadID: string` | `string` | `__property UnicodeString UploadID;` |
| `Action: string` | `string` | `__property UnicodeString Action;` |
| `Accept: string` | `string` | `__property UnicodeString Accept;` |
| `Multiple: Boolean` | `Boolean` | `__property bool Multiple;` |
| `MaxSize: string` | `string` | `__property UnicodeString MaxSize;` |
...
| `DragDropEnabled: Boolean` | `Boolean` | `__property bool DragDropEnabled;` |
| `InputName: string` | `string` | `__property UnicodeString InputName;` |
| `CSSClass: string` | `string` | `__property UnicodeString CSSClass;` |
| `IconHTML: string` | `string` | `__property UnicodeString IconHTML;` |
| `IconSize: string` | `string` | `__property UnicodeString IconSize;` |
| `IconColor: string` | `string` | `__property UnicodeString IconColor;` |
| `IconColorEnum: TsgcHTMLColor` | [TsgcHTMLColor](../types/TsgcHTMLColor.md) | `__property TsgcHTMLColor * IconColorEnum;` |
| `BorderStyle: string` | `string` | `__property UnicodeString BorderStyle;` |
| `ButtonStyle: TsgcHTMLButtonStyle` | [TsgcHTMLButtonStyle](../types/TsgcHTMLButtonStyle.md) | `__property TsgcHTMLButtonStyle * ButtonStyle;` |
