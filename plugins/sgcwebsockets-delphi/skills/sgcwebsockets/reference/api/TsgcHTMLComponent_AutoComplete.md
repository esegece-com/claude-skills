...
unit: sgcHTML_Component_AutoComplete
Edition: All-Access

Add `sgcHTML_Component_AutoComplete` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
...
| `Items: TStringList` | `TStringList` | `__property TStringList * Items;` |
| `AutoCompleteID: string` | `string` | `__property UnicodeString AutoCompleteID;` |
| `MinLength: Integer` | `Integer` | `__property int MinLength;` |
