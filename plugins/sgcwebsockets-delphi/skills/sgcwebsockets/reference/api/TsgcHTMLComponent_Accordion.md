...
| --- | --- | --- |
| `Items: TsgcHTMLAccordionItems` | [TsgcHTMLAccordionItems](../types/TsgcHTMLAccordionItems.md) | `__property TsgcHTMLAccordionItems * Items;` |
| `AccordionID: string` | `string` | `__property UnicodeString AccordionID;` |
| `Flush: Boolean` | `Boolean` | `__property bool Flush;` |
| `AlwaysOpen: Boolean` | `Boolean` | `__property bool AlwaysOpen;` |
