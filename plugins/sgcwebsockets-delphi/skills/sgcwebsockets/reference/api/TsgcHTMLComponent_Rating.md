...
unit: sgcHTML_Component_Rating
Edition: All-Access

Add `sgcHTML_Component_Rating` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `Value: Integer` | `Integer` | `__property int Value;` |
| `MaxValue: Integer` | `Integer` | `__property int MaxValue;` |
| `ReadOnly: Boolean` | `Boolean` | `__property bool ReadOnly;` |
| `Size: string` | `string` | `__property UnicodeString Size;` |
| `Color: string` | `string` | `__property UnicodeString Color;` |
| `EmptyColor: string` | `string` | `__property UnicodeString EmptyColor;` |
| `RatingID: string` | `string` | `__property UnicodeString RatingID;` |
| `InputName: string` | `string` | `__property UnicodeString InputName;` |
| `ShowValue: Boolean` | `Boolean` | `__property bool ShowValue;` |
| `ColorStyle: TsgcHTMLColor` | [TsgcHTMLColor](../types/TsgcHTMLColor.md) | `__property TsgcHTMLColor * ColorStyle;` |
| `EmptyColorStyle: TsgcHTMLColor` | [TsgcHTMLColor](../types/TsgcHTMLColor.md) | `__property TsgcHTMLColor * EmptyColorStyle;` |
| `FilledSymbol: string` | `string` | `__property UnicodeString FilledSymbol;` |
| `EmptySymbol: string` | `string` | `__property UnicodeString EmptySymbol;` |
