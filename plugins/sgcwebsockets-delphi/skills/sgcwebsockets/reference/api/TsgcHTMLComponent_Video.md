...
| `MediaType: TsgcHTMLMediaType` | [TsgcHTMLMediaType](../types/TsgcHTMLMediaType.md) | `__property TsgcHTMLMediaType * MediaType;` |
| `Controls: Boolean` | `Boolean` | `__property bool Controls;` |
| `Autoplay: Boolean` | `Boolean` | `__property bool Autoplay;` |
| `Loop: Boolean` | `Boolean` | `__property bool Loop;` |
| `Muted: Boolean` | `Boolean` | `__property bool Muted;` |
| `Width: string` | `string` | `__property UnicodeString Width;` |
| `Height: string` | `string` | `__property UnicodeString Height;` |
| `Poster: string` | `string` | `__property UnicodeString Poster;` |
| `VideoID: string` | `string` | `__property UnicodeString VideoID;` |
