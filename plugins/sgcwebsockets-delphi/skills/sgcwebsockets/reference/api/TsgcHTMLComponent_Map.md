...
| --- | --- | --- |
| `Markers: TsgcHTMLMapMarkers` | [TsgcHTMLMapMarkers](../types/TsgcHTMLMapMarkers.md) | `__property TsgcHTMLMapMarkers * Markers;` |
| `MapID: string` | `string` | `__property UnicodeString MapID;` |
| `Height: string` | `string` | `__property UnicodeString Height;` |
| `CenterLatitude: Double` | `Double` | `__property double CenterLatitude;` |
| `CenterLongitude: Double` | `Double` | `__property double CenterLongitude;` |
| `Zoom: Integer` | `Integer` | `__property int Zoom;` |
| `TileProvider: TsgcHTMLMapTileProvider` | [TsgcHTMLMapTileProvider](../types/TsgcHTMLMapTileProvider.md) | `__property TsgcHTMLMapTileProvider * TileProvider;` |
...
```pascal
procedure AddMarker(aLat, aLng: Double; const aPopup: string = ''; const aTooltip: string = '');
```

C++Builder

```cpp
void __fastcall AddMarker(double aLat, double aLng, const UnicodeString aPopup = '', const UnicodeString aTooltip = '');
```
