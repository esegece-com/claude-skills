...
Add `sgcHTML_Component_DatePicker` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `Mode: TsgcHTMLDatePickerMode` | [TsgcHTMLDatePickerMode](../types/TsgcHTMLDatePickerMode.md) | `__property TsgcHTMLDatePickerMode * Mode;` |
...
| `MinDate: string` | `string` | `__property UnicodeString MinDate;` |
| `MaxDate: string` | `string` | `__property UnicodeString MaxDate;` |
| `DatePickerID: string` | `string` | `__property UnicodeString DatePickerID;` |
