...
| `Checked: Boolean` | `Boolean` | `__property bool Checked;` |
| `Disabled: Boolean` | `Boolean` | `__property bool Disabled;` |
| `Switch: Boolean` | `Boolean` | `__property bool Switch;` |
| `CheckBoxID: string` | `string` | `__property UnicodeString CheckBoxID;` |
