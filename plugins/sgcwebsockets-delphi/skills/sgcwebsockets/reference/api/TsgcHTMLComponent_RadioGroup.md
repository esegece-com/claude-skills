...
| `SelectedIndex: Integer` | `Integer` | `__property int SelectedIndex;` |
| `InlineLayout: Boolean` | `Boolean` | `__property bool InlineLayout;` |
| `Disabled: Boolean` | `Boolean` | `__property bool Disabled;` |
| `RadioGroupID: string` | `string` | `__property UnicodeString RadioGroupID;` |
