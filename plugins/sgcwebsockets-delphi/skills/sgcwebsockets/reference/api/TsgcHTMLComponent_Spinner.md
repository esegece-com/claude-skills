...
Add `sgcHTML_Component_Spinner` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.

## Properties

| Delphi | Type | C++Builder |
| --- | --- | --- |
| `SpinnerType: TsgcHTMLSpinnerType` | [TsgcHTMLSpinnerType](../types/TsgcHTMLSpinnerType.md) | `__property TsgcHTMLSpinnerType * SpinnerType;` |
| `Size: TsgcHTMLSpinnerSize` | [TsgcHTMLSpinnerSize](../types/TsgcHTMLSpinnerSize.md) | `__property TsgcHTMLSpinnerSize * Size;` |
...
| `Text: string` | `string` | `__property UnicodeString Text;` |
| `SpinnerID: string` | `string` | `__property UnicodeString SpinnerID;` |
