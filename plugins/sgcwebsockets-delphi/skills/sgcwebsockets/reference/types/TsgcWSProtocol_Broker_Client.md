...
| Delphi | Type |
| --- | --- |
| `WSBrokerMessageWrite: TsgcWSBrokerMessage` | [TsgcWSBrokerMessage](./TsgcWSBrokerMessage.md) |
| `WSBrokerBinaryWrite: TsgcWSBrokerBinary` | [TsgcWSBrokerBinary](./TsgcWSBrokerBinary.md) |
| `Client: TsgcWSComponent_WSClient` | [TsgcWSComponent_WSClient](./TsgcWSComponent_WSClient.md) |
