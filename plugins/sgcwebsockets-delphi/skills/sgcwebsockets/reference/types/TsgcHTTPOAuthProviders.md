...
```pascal
procedure AddProvider(const aName, aClientId, aClientSecret, aAuthorizeURL, aTokenURL, aScope, aURL, aCallbackURL: string);
function GetProvider(const aName: string): TsgcHTTPOAuthProvider;
function RemoveProvider(const aName: string): Boolean;
