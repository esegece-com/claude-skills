# TsgcOpenAPI_Parser_Client

unit: sgcOpenAPI_Parser_Client

Add `sgcOpenAPI_Parser_Client` to your `uses` clause. Property and event types that link below are documented under `reference/types/`.
