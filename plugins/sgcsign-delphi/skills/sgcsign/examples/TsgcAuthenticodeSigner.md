# TsgcAuthenticodeSigner - Example

Full source of `frmMain.pas` from the **Authenticode** demo, which uses `TsgcAuthenticodeSigner`.

API reference: [TsgcAuthenticodeSigner](../reference/api/TsgcAuthenticodeSigner.md)
