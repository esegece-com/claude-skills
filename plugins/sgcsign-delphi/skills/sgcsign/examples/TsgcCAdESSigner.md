# TsgcCAdESSigner - Example

Full source of `frmMain.pas` from the **CAdES** demo, which uses `TsgcCAdESSigner`.

API reference: [TsgcCAdESSigner](../reference/api/TsgcCAdESSigner.md)
