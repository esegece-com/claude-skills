# TsgcDocumentSigner - Example

Full source of `frmMain.pas` from the **EFactura** demo, which uses `TsgcDocumentSigner`.

API reference: [TsgcDocumentSigner](../reference/api/TsgcDocumentSigner.md)
