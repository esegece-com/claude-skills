# TsgcAuthenticodeVerifier - Example

Full source of `frmMain.pas` from the **Authenticode** demo, which uses `TsgcAuthenticodeVerifier`.

API reference: [TsgcAuthenticodeVerifier](../reference/api/TsgcAuthenticodeVerifier.md)
