# TsgcTSAClient - Example

Full source of `frmMain.pas` from the **Authenticode** demo, which uses `TsgcTSAClient`.

API reference: [TsgcTSAClient](../reference/api/TsgcTSAClient.md)
