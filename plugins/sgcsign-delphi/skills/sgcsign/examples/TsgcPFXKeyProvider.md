# TsgcPFXKeyProvider - Example

Full source of `frmMain.pas` from the **Authenticode** demo, which uses `TsgcPFXKeyProvider`.

API reference: [TsgcPFXKeyProvider](../reference/api/TsgcPFXKeyProvider.md)
