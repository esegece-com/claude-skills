# TsgcWinBioStorageFile - Example

Full source of `FFingerPrint.pas` from the **FingerPrint** demo, which uses `TsgcWinBioStorageFile`.

API reference: [TsgcWinBioStorageFile](../reference/api/TsgcWinBioStorageFile.md)
