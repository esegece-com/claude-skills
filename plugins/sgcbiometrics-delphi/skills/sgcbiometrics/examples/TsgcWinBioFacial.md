# TsgcWinBioFacial - Example

Full source of `FFacial.pas` from the **Facial** demo, which uses `TsgcWinBioFacial`.

API reference: [TsgcWinBioFacial](../reference/api/TsgcWinBioFacial.md)
Source demo: `Facial` (file `FFacial.pas`)
